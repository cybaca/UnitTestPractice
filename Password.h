...
class Password {
     ...
     * occurs at the beginning of the string, before any other characters (or
     * the end of the string). The function is case-sensitive so 'Z' is
     * different than 'z' and any ASCII characters are allowed.
     */
